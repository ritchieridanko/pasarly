...
func (x *SetPrimaryAddressRequest) GetAuthId() int64 {
	if x != nil {
		return x.AuthId
	}
	return 0
...
func (x *SetPrimaryAddressRequest) GetAddressId() int64 {
	if x != nil {
		return x.AddressId
	}
	return 0
...
func (x *SetPrimaryAddressResponse) GetNewPrimaryAddress() *UserAddress {
	if x != nil {
...
func (x *SetPrimaryAddressResponse) GetOldPrimaryAddress() *UserAddress {
	if x != nil {
		return x.OldPrimaryAddress
	}
	return nil
...
const file_v1_user_address_api_proto_rawDesc = "" +
	...
	"\aaddress\x18\x01 \x01(\v2\x14.user.v1.UserAddressR\aaddress\"R\n" +
	"\x18SetPrimaryAddressRequest\x12\x17\n" +
	"\aauth_id\x18\x01 \x01(\x03R\x06authId\x12\x1d\n" +
	"\n" +
